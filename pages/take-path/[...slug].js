...
const TakePath = ({ path, mixpanel }) => {
  ...
  const authorIntro =
    path && !!path.authorIntro
      ? path.authorIntro
      : "🤷 Not much was found on this author";
  useEffect(() => {
  ...
  return (
    <div className="container">
      {path && <Header title={`To ${path["goal:name"]}, take this path`} />}
      ...
      <main>
        ...
        {path && (
          <div>
            ...
            <p>
              This place is all about taking a path toward a goal that others
              have crafted based on their experience.
            </p>
          </div>
        )}
          ...
          <>
            ...
            <p className="pullQuote">
              <Link href={authorProfileUrl}>
                <a id="authorProfileUrl" className="authorProfileUrl">
              ...
              <a
                ...
                onClick={() => {
                  ...
                  if (user && path) {
                    ...
                    if (mixpanel) {
                      console.log("MP", Events.TAKE_PATH, {
                        pathTakenId: pathTakenId
                      });
                      mixpanel.track(Events.TAKE_PATH, {
                        pathTakenId: pathTakenId
                      });
                    }
            ...
            <div id="getStarted" className="getStarted">
              ...
              <p>
                Created{" "}
                <span
                  className="underline md-tooltip--right"
                  data-md-tooltip={moment(path.createdAt).format(
                    "dddd, MMMM Do YYYY, h:mm:ss a"
                  )}
                >
                  {moment(path.createdAt).fromNow()}
                </span>
                , this path has{" "}
                <span
                  className="underline md-tooltip--right"
                  data-md-tooltip="paces"
                >
                  steps
                </span>{" "}
                that each take roughly {path["pace:duration"]} to do.
              </p>
              <br />
              <Link href={pathTakenUrl}>
                <a id="pathTakenUrl" className="buildPathUrl">
                  I'm in. Let's go!
                </a>
              </Link>
            </div>
